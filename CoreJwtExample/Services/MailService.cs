...
namespace CoreJwtExample.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendActivationCodeAsync(UserActivationCode request)
        {
            string FilePath = Directory.GetCurrentDirectory() + "\\Templates\\UserActivationCode.html";
